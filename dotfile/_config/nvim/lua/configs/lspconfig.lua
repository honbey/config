    ...
    vim.api.nvim_create_autocmd(
        "LspAttach",
        {
            ...
            callback = function()
                ...
                bufmap("n", "<leader>ks", ":Lspsaga show_line_diagnostics<cr>")
                bufmap("n", "<leader>kS", ":Lspsaga show_cursor_diagnostics<cr>")
                bufmap("n", "<leader>kd", ":Lspsaga preview_definition<cr>")
                bufmap("n", "<leader>kR", ":Lspsaga rename<cr>")
                bufmap("n", "<leader>kc", ":Lspsaga code_action<cr>")
                bufmap("n", "<leader>kl", ":Lspsaga lsp_finder<cr>")
                bufmap("n", "<leader>kp", ":Lspsaga diagnostic_jump_prev<cr>")
                bufmap("n", "<leader>kn", ":Lspsaga diagnostic_jump_next<cr>")
